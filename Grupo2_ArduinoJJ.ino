...
#define HTTP_OTA_ADDRESS      F("192.168.1.33")       // Dirección del servidor de actualización OTA, aunque el real sería el definido como OTA_URL
...
const char* ssid="MOVISTAR_JUANJO";          // INTRODUCIR SSID PROPIO DE CADA USUARIO
const char* password="juanjoesincreibl3-";    // INTRODUCIR PASSWORD PROPIA DE CADA USUARIO
