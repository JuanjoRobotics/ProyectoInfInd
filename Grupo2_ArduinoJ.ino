...
#define HTTP_OTA_ADDRESS      F("150.214.109.72")       // Dirección del servidor de actualización OTA
...
const char* ssid = "ALFIL_PISOS";           // INTRODUCIR SSID PROPIO DE CADA USUARIO
const char* password = "alfil2020";         // INTRODUCIR PASSWORD PROPIA DE CADA USUARIO
